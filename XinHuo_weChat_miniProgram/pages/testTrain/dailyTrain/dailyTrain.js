...
Page({
    ...
    getQuestionList() {
        ...
        wx.cloud.callFunction({
            name: 'sqlOperation',
            data: {
                sql: "select * from pratice_test_sheet where type = '每日答题' and id = 1"
            },
            success: function (res) {
                console.log('已获得题目信息', res.result[0].content)
                ...
                success(res) {
                    if (res.confirm) {
                        ...
                        wx.cloud.callFunction({
                            name: 'sqlOperation',
                            data: {
                                sql: "insert into gift_score_record(id,stuNumber,action,time,value) values ('" + randomuuid + "', '32001251', '" + that.data.type + "', '" + nowTime + "', 5)"
                            },
                            success: function (res) {
